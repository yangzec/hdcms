...
INSERT INTO `hd_category` VALUES (1,1,'1','1','1','','1.html','1.html',0,0,'1','{catdir}/{Y}/{1'),(2,0,'1','1','1','','{style}/news_list.html','{style}/news_article.html',1,1,'{catdir}/list_{cid}_{page}.html','{catdir}/{Y}/{M}{D}/{aid}.html'),(3,1,'gd','gd','gd','','{style}/news_list.html','{style}/news_article.html',1,0,'{catdir}/list_{cid}_{page}.html','{catdir}/{Y}/{M}{D}/{aid}.html'),(4,5,'function23','function','function','','{style}/news_list.html','{style}/news_article.html',1,0,'{catdir}/list_{cid}_{page}.html','{catdir}/{Y}/{M}{D}/{aid}.html'),(5,3,'sdf','sdfs','df','','{style}/news_list.html','{style}/news_article.html',1,0,'{catdir}/list_{cid}_{page}.html','{catdir}/{Y}/{M}{D}/{aid}.html');
...
-- Dump completed on 2013-07-08 12:37:04

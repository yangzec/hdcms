...
$db->exe("REPLACE INTO ".$db_prefix."member_group (`gid`,`is_system`,`point`,`allowpost`,`allowpostverify`,`allowsendmessage`,`description`,`gname`) VALUES('2','1','100','1','0','0','新手上路','新手上路')");

...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Template&c=Style&m=index&_=0.6040446774419684';
    ...
    <div class="tpl-list">
        <ul>
            <li>
                ...
                <div class="link">
                    <a href="javascript:;" class="btn" onclick="select_tpl('<?php echo $style_cur['dir_name'];?>')">使用</a>
...
if($_index_t>=$_total_t):$hd["list"]["t"]["last"]=true;endif;?>
                ...
                <li>
                    ...
                    <div class="link">
                        <a href="javascript:;" class="btn" onclick="select_tpl('<?php echo basename($t['dir_name']);?>')">使用</a>
                        <a href="<?php echo U('show_dir',array('dir_name'=>$style_cur['dir_name']));?>" class="btn">编辑</a>
                    </div>
                </li>

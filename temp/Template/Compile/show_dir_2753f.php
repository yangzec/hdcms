...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Template&c=Style&m=show_dir&_=0.7088959200678849';
            ...
            <tr>
                ...
                <td>
                    <?php if($d['type']=='dir'){?>
                        ...
                        <?php  }else{ ?>
                            <a href="javascript:;" onclick="_open('http://localhost/hdcms/index.php?a=Template&c=Style&m=edit_tpl&file_path=<?php echo urlencode($d['path']);?>')">修改</a>
                    <?php }?>
                </td>
            </tr>

        ...
        <td>
            <table class="table1">
                <tr>
                    ...
                    <td><input type="text"  name="set[input_width]" class="w100 images_input_width" value="100"/> px</td>
                </tr>
                <tr>
                    <td class="w100">图片宽度</td>
                    <td>
                        <label><input type="text" class="w100 image_height" name="set[width]" value="260"/> px
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <label><input type="text" class="w100 image_width" name="set[height]" value="260"/> px
                        </label>
                    </td>
                </tr>
                <tr>
                    <td>允许上传的个数</td>
                    <td>
                        <input type="text" class="w100 images_num" name="set[num]" value="10"/> 个
                    </td>
                </tr>
                <tr>
                    <td>是否添加水印</td>

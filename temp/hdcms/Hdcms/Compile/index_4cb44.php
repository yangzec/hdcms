...
<script type='text/javascript'>
    ...
    <link type="text/css" rel="stylesheet" href="http://localhost/hdcms/hdphp/hdcms/Hdcms/Tpl/Index/css/css.css"/>
    <script type="text/javascript" src="http://localhost/hdcms/hdphp/hdcms/Hdcms/Tpl/Index/js/js.js"></script>
</head>
<body>
<div class="nav">
    <!--头部左侧导航-->

...
<head>
  ...
  <![endif]--><link href="http://localhost/hdphp/hdphp/Extend/Org/hdui/css/hdui.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/hdui/js/hdui.js"></script>
    ...
    <script type="text/javascript" src="http://localhost/hdcms/hdphp/hdcms/Admin/Tpl/Admin/js/add_validation.js"></script>
...
<div class="wrap">
    ...
    <form action="<?php echo U('add');?>" method="post" class="form-inline" onsubmit="return hd_dialog(this,'http://localhost/hdcms/index.php?a=Admin&c=Admin')">
        <table class="table1">
            <tr>

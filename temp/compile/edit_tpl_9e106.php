...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Template&c=Style&m=edit_tpl&tpl_name=%2Fwww%2Fhdcms%2Ftemplate%2Fdefault%2Farticle_default.html';
    ...
    <script>
        var HISTORY_URL = "<?php echo $field['history_url'];?>";
    </script>
</head>
<body>
<div class="wrap">
    ...
    <form action="<?php echo U(add);?>" method="post" onsubmit="return false;">
        <input type="hidden" name="file" value="<?php echo $field['file'];?>"/>
        <!--右侧缩略图区域-->
        <table class="table1">
            <tr>
                <th class="w100">文件名</th>
                <td>
                    <input type="text" name="filename" value="<?php echo $field['filename'];?>" class="w300"/>
                </td>
            </tr>
            <tr>
                <th class="w100">内容</th>

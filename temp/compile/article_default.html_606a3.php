	...
	<div id="latest_news_box">
        <div id="latest_news">
            <p><span class="title">最新消息：</span>
                        <?php $mid="1";$cid ="4";$listtype ="";$flag='';$aid='';
            $_GET['mid']="1";
            if(empty($cid)){
	...
	<div id="page_main">
		...
		<div class="right">
			...
			<div class="right_list">
				<ul>
                            <?php $mid="1";$cid ="2,3,4,5";$listtype ="";$flag='4';$aid='';
            $_GET['mid']="1";
            if(empty($cid)){
                $cid= isset($_GET['cid'])?intval($_GET['cid']):null;
            }
		...
		<div class="left">
			...
			<div class="article_info_box">
                <p class="article_info">
                    ...
                    <script src="http://localhost/hdcms/index.php?a=Content&c=Content&m=get_click&cid=<?php echo $_GET['cid'];?>&aid=<?php echo $_GET['aid'];?>"></script>次浏览
                </p>
			</div>
			<!-- 文章信息结束 -->

<?php if(!defined("HDPHP_PATH"))exit;C("DEBUG_SHOW",false);?><link type="text/css" rel="stylesheet" href="http://localhost/hdcms/hdcms/App/Template/Tpl/Template/css/css.css"/>
<script>
    $(function () {
        //切换目录
        $(".dir").click(function () {

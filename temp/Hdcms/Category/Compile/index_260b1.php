...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Category&c=Category&m=index&_=0.6610899971296121';
...
<div class="btn_wrap">
    <input type="button" class="btn btn-primary" onclick="update_order()" value="更改排序"/>
</div>
</body>
</html>
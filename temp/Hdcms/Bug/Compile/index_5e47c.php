...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Bug&C=Index&m=index&status=1&_=0.5740204177317304';
		...
		TPL = 'http://localhost/hdcms/hdphp/hdcms/Bug/Tpl';
		CONTROLTPL = 'http://localhost/hdcms/hdphp/hdcms/Bug/Tpl/Index';
		STATIC = 'http://localhost/hdcms/hdphp/hdcms/Bug/Tpl/Static';
		PUBLIC = 'http://localhost/hdcms/hdphp/hdcms/Bug/Tpl/Public';
  ...
  <![endif]--><link href="http://localhost/hdphp/hdphp/Extend/Org/hdui/css/hdui.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/hdui/js/hdui.js"></script>
    <script type="text/javascript" src="http://localhost/hdcms/hdphp/hdcms/Bug/Tpl/Index/js/js.js"></script>
    <link type="text/css" rel="stylesheet" href="http://localhost/hdcms/hdphp/hdcms/Bug/Tpl/Index/css/css.css"/>
</head>
<body>
<div class="wrap">
    <div class="menu_list">

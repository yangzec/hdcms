...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Menu&c=Menu&m=set_favorite&_=0.23047722167598061';
		...
		TPL = 'http://localhost/hdcms/hdphp/hdcms/Menu/Tpl';
		CONTROLTPL = 'http://localhost/hdcms/hdphp/hdcms/Menu/Tpl/Menu';
		STATIC = 'http://localhost/hdcms/hdphp/hdcms/Menu/Tpl/Static';
		PUBLIC = 'http://localhost/hdcms/hdphp/hdcms/Menu/Tpl/Public';
  ...
  <![endif]--><link href="http://localhost/hdphp/hdphp/Extend/Org/hdui/css/hdui.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/hdui/js/hdui.js"></script>
    ...
    <script type="text/javascript" src="http://localhost/hdcms/hdphp/hdcms/Menu/Tpl/Menu/js/js.js"></script>
    <link type="text/css" rel="stylesheet" href="http://localhost/hdcms/hdphp/hdcms/Menu/Tpl/Menu/css/css.css"/>
</head>
<body>
<form method="post" action="http://localhost/hdcms/index.php?a=Menu&c=Menu&m=set_favorite">
    <div class="wrap">

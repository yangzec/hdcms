...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Admin&c=Personal&m=edit_info&_=0.6629152816002827';
  ...
  <![endif]--><link href="http://localhost/hdphp/hdphp/Extend/Org/hdui/css/hdui.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/hdui/js/hdui.js"></script>
    ...
    <script type="text/javascript" src="http://localhost/hdcms/hdphp/hdcms/Admin/Tpl/Personal/js/js.js"></script>
...
<div class="wrap">
    ...
    <form action="<?php echo U('edit_info');?>" method="post" onsubmit="return hd_dialog(this)">

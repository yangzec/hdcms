...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Config&c=Config&m=edit&_=0.09556680410361063';
		...
		TPL = 'http://localhost/hdcms/hdphp/hdcms/Config/Tpl';
		CONTROLTPL = 'http://localhost/hdcms/hdphp/hdcms/Config/Tpl/Config';
		STATIC = 'http://localhost/hdcms/hdphp/hdcms/Config/Tpl/Static';
		PUBLIC = 'http://localhost/hdcms/hdphp/hdcms/Config/Tpl/Public';
  ...
  <![endif]--><link href="http://localhost/hdphp/hdphp/Extend/Org/hdui/css/hdui.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/hdui/js/hdui.js"></script>
    ...
    <script type="text/javascript" src="http://localhost/hdcms/hdphp/hdcms/Config/Tpl/Config/js/js.js"></script>
    <link type="text/css" rel="stylesheet" href="http://localhost/hdcms/hdphp/hdcms/Config/Tpl/Config/css/css.css"/>
</head>
<body>

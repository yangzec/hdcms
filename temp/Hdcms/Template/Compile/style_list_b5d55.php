...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Template&c=Template&m=style_list&_=0.026087167000396594';
  ...
  <![endif]--><link href="http://localhost/hdphp/hdphp/Extend/Org/hdui/css/hdui.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/hdui/js/hdui.js"></script>
    ...
    <script type="text/javascript" src="http://localhost/hdcms/hdphp/hdcms/Template/Tpl/Template/js/style.js"></script>
...
if($_index_t>=$_total_t):$hd["list"]["t"]["last"]=true;endif;?>
                ...
                <li>
                    ...
                    <div class="link">
                        <a href="javascript:;" class="btn" onclick="select_style('<?php echo basename($t['dir_name']);?>')">使用</a>
                        <a href="<?php echo U('show_dir',array('dir_name'=>$style_cur['dir_name']));?>" class="btn">编辑</a>
                    </div>
                </li>

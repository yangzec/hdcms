...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Template&c=Template&m=show_dir&_=0.6718185947169835';
		...
		TPL = 'http://localhost/hdcms/hdphp/hdcms/Template/Tpl';
		CONTROLTPL = 'http://localhost/hdcms/hdphp/hdcms/Template/Tpl/Template';
		STATIC = 'http://localhost/hdcms/hdphp/hdcms/Template/Tpl/Static';
		PUBLIC = 'http://localhost/hdcms/hdphp/hdcms/Template/Tpl/Public';
  ...
  <![endif]--><link href="http://localhost/hdphp/hdphp/Extend/Org/hdui/css/hdui.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/hdui/js/hdui.js"></script>
    ...
    <script type="text/javascript" src="http://localhost/hdcms/hdphp/hdcms/Template/Tpl/Template/js/js.js"></script>
    <link type="text/css" rel="stylesheet" href="http://localhost/hdcms/hdphp/hdcms/Template/Tpl/Template/css/css.css"/>
</head>
<body>
<div class="wrap">
            ...
            <tr>
                ...
                <td>
                    <?php if($d['type']=='dir'){?>
                        ...
                        <?php  }else{ ?>
                            <a href="javascript:;" onclick="_open('http://localhost/hdcms/index.php?a=Template&c=Template&m=edit_tpl&file_path=<?php echo urlencode($d['path']);?>')">修改</a>
                    <?php }?>
                </td>
            </tr>

...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Template&c=Template&m=edit_tpl&file_path=%2Fwww%2Fhdcms%2Ftemplate%2Fdefault%2Farticle_list.html';
		...
		METH = 'http://localhost/hdcms/index.php?a=Template&c=Template&m=edit_tpl';
  ...
  <![endif]--><link href="http://localhost/hdphp/hdphp/Extend/Org/hdui/css/hdui.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/hdui/js/hdui.js"></script>
    <script type="text/javascript" src="http://localhost/hdcms/hdphp/hdcms/Template/Tpl/Template/js/edit_tpl.js"></script>

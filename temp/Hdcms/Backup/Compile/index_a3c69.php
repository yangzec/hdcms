...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Backup&c=Backup&m=index&_=0.5635375294951983';
		...
		TPL = 'http://localhost/hdcms/hdphp/hdcms/Backup/Tpl';
		CONTROLTPL = 'http://localhost/hdcms/hdphp/hdcms/Backup/Tpl/Backup';
		STATIC = 'http://localhost/hdcms/hdphp/hdcms/Backup/Tpl/Static';
		PUBLIC = 'http://localhost/hdcms/hdphp/hdcms/Backup/Tpl/Public';
  ...
  <![endif]--><link href="http://localhost/hdphp/hdphp/Extend/Org/hdui/css/hdui.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/hdui/js/hdui.js"></script>
    ...
    <script type="text/javascript" src="http://localhost/hdcms/hdphp/hdcms/Backup/Tpl/Backup/js/js.js"></script>
    <link type="text/css" rel="stylesheet" href="http://localhost/hdcms/hdphp/hdcms/Backup/Tpl/Backup/css/css.css"/>
</head>
<body>
<div class="wrap">
    <div class="menu_list">

...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Flag&c=Flag&m=index&_=0.0822102635677241';
		...
		TPL = 'http://localhost/hdcms/hdphp/hdcms/Flag/Tpl';
		CONTROLTPL = 'http://localhost/hdcms/hdphp/hdcms/Flag/Tpl/Flag';
		STATIC = 'http://localhost/hdcms/hdphp/hdcms/Flag/Tpl/Static';
		PUBLIC = 'http://localhost/hdcms/hdphp/hdcms/Flag/Tpl/Public';
  ...
  <![endif]--><link href="http://localhost/hdphp/hdphp/Extend/Org/hdui/css/hdui.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/hdui/js/hdui.js"></script>
    <link type="text/css" rel="stylesheet" href="http://localhost/hdcms/hdphp/hdcms/Flag/Tpl/Flag/css/css.css"/>
    <script type="text/javascript" src="http://localhost/hdcms/hdphp/hdcms/Flag/Tpl/Flag/js/js.js"></script>
</head>
<body>
<div class="wrap">
    <div class="menu_list">

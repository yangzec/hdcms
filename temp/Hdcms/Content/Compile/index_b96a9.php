...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Content&c=Content&m=index&_=0.14724397884555984';
  ...
  <![endif]--><link href="http://localhost/hdphp/hdphp/Extend/Org/hdui/css/hdui.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/hdui/js/hdui.js"></script>
    ...
    <script type="text/javascript" src="http://localhost/hdcms/hdphp/hdcms/Content/Tpl/Content/js/index.js"></script>
    <link rel='stylesheet' href='http://localhost/hdcms/hdphp/hdcms/Content/Tpl/Content/js/treeview/jquery.treeview.css'/>
    <script src='http://localhost/hdcms/hdphp/hdcms/Content/Tpl/Content/js/treeview/lib/jquery.cookie.js' type='text/javascript'></script>
    <script src='http://localhost/hdcms/hdphp/hdcms/Content/Tpl/Content/js/treeview/jquery.treeview.js' type='text/javascript'></script>
    <script src='http://localhost/hdcms/hdphp/hdcms/Content/Tpl/Content/js/treeview/jquery.treeview.edit.js' type='text/javascript'></script>
    <base target="content"/>
</head>
<body>
<div class="wrap">

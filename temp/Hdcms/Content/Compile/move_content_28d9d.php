...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Content&c=Content&m=move_content&cid=5&aid=39';
  ...
  <![endif]--><link href="http://localhost/hdphp/hdphp/Extend/Org/hdui/css/hdui.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/hdui/js/hdui.js"></script>
    ...
    <script type="text/javascript" src="http://localhost/hdcms/hdphp/hdcms/Content/Tpl/Content/js/move_content.js"></script>
    <link type="text/css" rel="stylesheet" href="http://localhost/hdcms/hdphp/hdcms/Content/Tpl/Content/css/move_content.css"/>
</head>
<body>
<div class="wrap">

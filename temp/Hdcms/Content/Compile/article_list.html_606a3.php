...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/hdcms/template/default 2//css/style.css"/>
    <link rel="stylesheet" href="http://localhost/hdcms/template/default 2//css/list.css"/>
    <script type="text/javascript" src="http://localhost/hdcms/template/default 2//js/jquery-1.7.2.min.js"></script>
    <script type="text/javascript" src="http://localhost/hdcms/template/default 2//js/js.js"></script>
</head>
...
<div id="top_dark_box">
    <!-- 中间1200px宽度区域 -->
    <div id="top_dark">
        <img src="http://localhost/hdcms/template/default 2//images/others/logo.png" id="logo"/>
        <!-- 导航菜单 -->
        <ul id="menu">
            <li>
...
<div id="latest_news_box">
    <div id="latest_news">
        <p><span class="title">最新消息：</span>        <?php $mid="1";$cid ="4";$listtype ="";$flag='';$aid='';
            $_GET['mid']="1";
            if(empty($cid)){
...
//        p($db->getallsql());exit;
  ...
  <![endif]--><link href="http://localhost/hdphp/hdphp/Extend/Org/hdui/css/hdui.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/hdui/js/hdui.js"></script>
    ...
    <div class="center">
        ...
        <ul class="title_list">
                    <?php $mid="1";$cid ="";$listtype ="";$flag='3';$aid='';
            $_GET['mid']="1";
            if(empty($cid)){
                $cid= isset($_GET['cid'])?intval($_GET['cid']):null;
            }
        ...
        <ul class="title_list">
                    <?php $mid="1";$cid ="";$listtype ="";$flag='2';$aid='';
            $_GET['mid']="1";
            if(empty($cid)){
                $cid= isset($_GET['cid'])?intval($_GET['cid']):null;
            }
    ...
    <div class="right">
        ...
        $field['url'] = 'http://localhost/hdcms/index.php?a=Content&c=Index&m=content&cid='.$field['cid'].'&aid='.$field['aid'].'#'.$field['comment_id'];?>
                <li>
                    <a href="<?php echo $field['url'];?>">
                        <img src="http://localhost/hdcms/template/default 2//images/others/touxiang.png" alt=""/>
        ...
        <ul class="title_list">
                    <?php $mid="1";$cid ="2,3,4,5";$listtype ="";$flag='';$aid='';
            $_GET['mid']="1";
            if(empty($cid)){
                $cid= isset($_GET['cid'])?intval($_GET['cid']):null;
            }

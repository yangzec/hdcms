...
<head>
    ...
    <script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Html&c=Html&m=create_content';
		...
		METH = 'http://localhost/hdcms/index.php?a=Html&c=Html&m=create_content';
...
<body>
<form method="post" action="http://localhost/hdcms/index.php?a=Html&c=Html&m=make_content">
    <div class="wrap">

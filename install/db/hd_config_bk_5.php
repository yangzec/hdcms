...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`) VALUES('3','htmldir','html','站点配置','静态html目录','文本')");
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`) VALUES('151','WEB_STYLE','default','站点配置','网站模板','文本')");

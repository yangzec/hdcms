    ...
    <div class="wrap">
        ...
        <table class="table1">
            ...
            <tr>
                ...
                <td>
                    <label><input type="radio" name="ismember" value="1" <if value='$field.ismember==1'>checked="checked"</if>/> 是</label>
                    <label><input type="radio" name="ismember" value="0" <if value='$field.ismember==0'>checked="checked"</if>/> 否</label>
                </td>
            </tr>
            <tr>
                <td>

...
CREATE TABLE `hd_model` (
  ...
  PRIMARY KEY (`mid`)
) ENGINE=MyISAM AUTO_INCREMENT=124 DEFAULT CHARSET=utf8 COMMENT='模型表';
...
CREATE TABLE `hd_model_field` (
  ...
  PRIMARY KEY (`fid`,`mid`),
  KEY `mid` (`mid`)
) ENGINE=MyISAM AUTO_INCREMENT=566 DEFAULT CHARSET=utf8 COMMENT='模型字段';
